# -*- coding: utf-8 -*-
"""Figure3_Burgers_simulation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/phuongle0701/AMATH741_project_numerical_pde/blob/main/Codes/Figure3_Burgers_simulation.ipynb
...
#line = np.linspace(lb_sol[1], ub_sol[1], 2)[:,None]
#ax.plot(t_idn[index]*np.ones((2,1)), line, 'w-', linewidth = 1)
savefig('/content/figures/Figure3Paper')

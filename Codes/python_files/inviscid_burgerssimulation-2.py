# -*- coding: utf-8 -*-
"""Inviscid_BurgersSimulation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/phuongle0701/AMATH741_project_numerical_pde/blob/main/Codes/Inviscid_BurgersSimulation.ipynb
...
class DeepHPM:
    ...
    def idn_net_f(self, t, x):
        ...
        terms = tf.concat([u,u_x],1) ## modfiy the right hand side of N(u,u_x)
...
data_idn = scipy.io.loadmat('/content/Data/inv_burgers_cosine.mat')
...
data_sol = scipy.io.loadmat('/content/Data/inv_burgers_cosine.mat') 
...
noise =  0.01 #0.00 # 0.001, 0.002, 0.01
...
print('Error u: %.3e' % (error_u_identifier))
...
print('Error u: %.3e' % (error_u))
print('Error u (idn): %.3e' % (error_u_idn))
...
savefig('/content/figures/Inv_Burgers_Cosine')
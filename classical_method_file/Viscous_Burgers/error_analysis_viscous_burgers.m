function error_analysis_viscous_burgers
...
dt=[3.5e-3,2.7e-3,1.95e-3]'; 
%load the data: sine initial condition.
truth=load('burgers_sine','-mat');
approx1=load('vis_burgers_sine_dt1','-mat');
approx2=load('vis_burgers_sine_dt2','-mat');
approx3=load('vis_burgers_sine_dt3','-mat');
...
disp(['Relative Error for Exp initial condition'])
dt=[3.5e-3,2.7e-3,1.95e-3]';  
%load the data: sine initial condition.
truth=load('burgers_exp','-mat');
approx1=load('vis_burgers_exp_dt1','-mat');
approx2=load('vis_burgers_exp_dt2','-mat');
approx3=load('vis_burgers_exp_dt3','-mat');
